...
from data.dummy_complexes import (get_house_complex, get_kite_complex, get_square_complex,
                                  get_square_dot_complex, get_filled_square_complex, get_crate_complex,
...
__cell_dummy_mol_complexes__ = [
            get_house_complex, get_kite_complex, get_square_complex, get_fullstop_complex, get_crate_complex,
            get_square_dot_complex, get_square_complex, get_filled_square_complex, get_colon_complex, get_crate_complex,
            get_kite_complex, get_square_dot_complex, get_colon_complex, get_molecular_complex, get_crate_complex,
