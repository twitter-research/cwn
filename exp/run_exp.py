...
from mp.ringtree_models import RingTreeSparseSIN, RingTreeGIN
...
def main(args):
    ...
    elif args.model == 'ringtree_sparse_sin':
        model = RingTreeSparseSIN(
    ...
    elif args.model == 'gin_ringtree':
        model = RingTreeGIN(num_features,                            # num_input_features
                            args.num_layers,                         # num_layers
                            args.emb_dim,                            # hidden
                            num_classes,                             # num_classes
                            nonlinearity=args.nonlinearity,          # nonlinearity
